...
//   return (
//     <footer className="bg-zinc-700 py-8 flex items-center justify-center gap-24">

//       <div className="text-gray-300 text-center flex flex-col items-center justiy-center gap-2">
//         <h3 className="mt-2">Malmö Macarons</h3>
...
//         <nav className="flex justify-center space-x-4 text-2xl text-gray-400">
...
//             </a>
//             <a href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-500">
  ...
  return (
    <footer className="bg-zinc-700 py-8 px-6 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 text-center">
      ...
      <div className="text-gray-300 flex flex-col items-center gap-2">
        <h3 className="text-lg font-semibold">Malmö Macarons</h3>
